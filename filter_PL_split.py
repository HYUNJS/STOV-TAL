...
if __name__ == '__main__':
    '''
    python filter_pseudo_proposal_split.py  --dataset thumos14 --Tsplit 50-0 --Esplit non50-0 --subset training --model vifi
    python filter_pseudo_proposal_split.py  --dataset thumos14 --Tsplit K400 --Esplit nonK400 --subset training --model vifi
    '''
    ...
    # th14_ckpt_cfg = f'thumos14_{model}_prop_{split_type}_{th_ver}'
    # thumos14_train_prop = f'./ckpt/TH_agn_{split_type}/{th14_ckpt_cfg}/proposal_TH_{subset}_{Esplit}_tal_ema/{th14_ckpt_cfg}_epoch_{th_ep}.json'
