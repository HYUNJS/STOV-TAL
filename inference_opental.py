...
def main(args):
    ...
    load_proposal_cfg = {}
    load_proposal_result = cfg['test_cfg']['load_proposal_result']
    if load_proposal_result:
        proposal_filepath = cfg['test_cfg']['proposal_filepath']
        load_proposal_cfg = {'load_proposal_result': load_proposal_result, 'proposal_filepath': proposal_filepath}
    ...
    val_dataset = make_dataset(
        cfg['dataset_name'], False, cfg['val_split'], **load_proposal_cfg, **cfg['dataset']
    )
    ...
    if load_proposal_result:
        model_cfg = proposal_filepath.split('/')[-2]
        proposal_filename = f'{model_cfg}.json'
    else:
