...
CUDA_VISIBLE_DEVICES=1 python train.py ${cfg_name} ${ckpt} ${v3_output_dir} --opts ${anno} ${ckpt_folder_v3} ${v3_train_cfg} &
sleep 3
CUDA_VISIBLE_DEVICES=1 python train.py ${cfg_name} ${ckpt} ${v6_output_dir} --opts ${anno} ${ckpt_folder_v6} ${v6_train_cfg} &
sleep 3
CUDA_VISIBLE_DEVICES=3 python train.py ${cfg_name} ${ckpt} ${v7_output_dir} --opts ${anno} ${ckpt_folder_v7} ${v7_train_cfg} &
sleep 3
