...
#     train_json="dataset.train_json_file ./data/joint/PL_TH-75-${i}_to_UK600-${split}_vifi_ver_0/T-TH-75-${i}_E-UK600-${split}_th-${thresh}_min-1.json"
...
output="split${i}_${ver}_th-${thresh}_load_as_ema"
train_json="dataset.train_json_file ./data/joint/PL_TH-75-${i}_to_UK600-${split}_vifi_ver_0/T-TH-75-${i}_E-UK600-${split}_th-${thresh}_min-1.json"
CUDA_VISIBLE_DEVICES=2 python train.py ${cfg_name} ${ckpt} --output ${output} --opts ${train_json} ${train_cfg} ${split_id} &

i=8
split_id="dataset.split_id ${i}"
output="split${i}_${ver}_th-${thresh}_load_as_ema"
train_json="dataset.train_json_file ./data/joint/PL_TH-75-${i}_to_UK600-${split}_vifi_ver_0/T-TH-75-${i}_E-UK600-${split}_th-${thresh}_min-1.json"
CUDA_VISIBLE_DEVICES=3 python train.py ${cfg_name} ${ckpt} --output ${output} --opts ${train_json} ${train_cfg} ${split_id} &