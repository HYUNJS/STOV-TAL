...
# CUDA_VISIBLE_DEVICES=0 python train.py configs/${dataset}_split/${dataset}_vifi_non50_pseudo_tmpl.yaml --output split${i}_th${th}_${VER} --opts ${train_json} ${val_json}&
# sleep 5;
